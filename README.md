...
#### Senior WordPress Developer at edited.com, UK/Bulgaria (Sep 2023 - now)
- **WordPress Development**: Development and maintenance of company website and internal systems using WordPress, including custom themes and plugins following best practices.
...
- **Custom Development**: Develop custom themes, plugins, and functionality with extensive use of WordPress APIs, PHP, MySQL, JavaScript, TypeScript, and React.
- **ReactJS Components**: Create reusable and responsive ReactJS components for dynamic user interfaces, integrating them with WordPress backend for seamless functionality.
- **Performance & Quality**: Optimize website performance, ensure code quality, and implement security best practices and SEO principles.
- **Testing & Troubleshooting**: Conduct thorough testing and debugging to ensure seamless website functionality across multiple devices and browsers, efficiently resolving complex issues.
- **Marketing Integration**: Build marketing campaigns with experience in HubSpot, Google Tag Manager, and Pendo.
- **AI Integration**: Implement AI-powered features using OpenAI API and LangChain for content generation, intelligent automation, and enhanced user experience through prompt engineering and chatbot integration.
- **CI/CD and Best Practices**: Configure Continuous Integration/Continuous Deployment pipelines, introduce code style standards, and manage version control with Git.
...
- **Key Projects**:
  - **Test Management Tool** (CodeIgniter):
    - Backend: REST API V3 development, OpenAPI documentation with Swagger, webhooks implementation
    - PHP 7 to 8 migration: code validation, testing, and migration of modules including Cassandra adapter
    - Frontend: Charts implementation using FusionCharts, XSS protection and security improvements
  - **Cloud-based API and SaaS Solution**:
    - Bug fixing and support of legacy code for automated data collection
    - Data aggregation from search engines, maps, stock exchanges and other popular resources
    - Microservices architecture using Laravel, Symfony, and Flask frameworks
